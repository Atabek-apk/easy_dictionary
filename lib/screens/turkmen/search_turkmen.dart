...
class SearchTurkmen extends StatefulWidget {
  const SearchTurkmen({Key? key}) : super(key: key);

  @override
  State<SearchTurkmen> createState() => _SearchTurkmenState();
}

final controller = TextEditingController();
List<Words> words = allWords;

class _SearchTurkmenState extends State<SearchTurkmen> {
  @override
          ...
          words.isEmpty
              ? Column(
                  children: [
                    ...
                    Text('Siziň gözleýän sözüňiz tapylamdy !',
  ...
  void searchWord(String query) {
    final sugges = allWords.where((word) {
      final wordTitle = word.turkmen.toLowerCase();
